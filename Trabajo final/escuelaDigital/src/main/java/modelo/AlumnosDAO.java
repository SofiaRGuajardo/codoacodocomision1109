...
public class AlumnosDAO {
    ...
    public Alumnos mostrarAlumnos(int _id){
        ...
        try{
            ps = conexion.prepareStatement("SELECT id,nombres,apellidos,email,telefono FROM participantes "
            + "Where id = ?");
            ps.setInt(1, _id);
            rs = ps.executeQuery();
    ...
    public boolean insertarAlumno(Alumnos alumno){
        ...
        try{
            ps = conexion.prepareStatement("INSERT INTO participantes"
                    + "(nombres,apellidos,email,telefono)VALUES(?,?,?,?)");
    ...
    public boolean actualizarAlumno(Alumnos alumno){
        PreparedStatement ps;
        try{
            ps = conexion.prepareStatement("UPDATE participantes SET nombres=?, apellidos=?, "
